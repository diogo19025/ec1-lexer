...
# test-lex-ev     : análise léxica da linguagem EV       (Atividade 08)
# test-parser-ev  : parser + análise semântica da EV     (Atividade 08)
# test-cod-ev     : geração de código da linguagem EV    (Atividade 08) — requer Linux com as/ld
